        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-4">
            <div className="flex flex-col md:flex-row items-center gap-6 p-4 border rounded-lg">
              <Image src="https://placehold.co/150x150.png" alt="Foto do Perfil" width={150} height={150} className="rounded-full" data-ai-hint="profile avatar" />
              <div>
                <h3 className="text-xl font-semibold">Nome do Paciente</h3>
                <p className="text-muted-foreground">paciente@email.com</p>
